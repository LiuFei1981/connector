...
import (
	...
	"github.com/LiuFei1981/connector/adapters/circuitbreaker"
	"github.com/LiuFei1981/connector/internal/safego"
	"github.com/LiuFei1981/connector/adapters/circuitbreaker/plugins"
	"github.com/LiuFei1981/connector/adapters/health"
	"github.com/LiuFei1981/connector/adapters/loadbalancer"
	"github.com/LiuFei1981/connector/adapters/queue"
	"github.com/LiuFei1981/connector/adapters/registry"
	res "github.com/LiuFei1981/connector/adapters/resolver"
	"github.com/LiuFei1981/connector/adapters/tracer"
...
type Client struct {
	...
	// redis service discovery (fallback when CloudMap is unavailable)
...
func (c *Client) Close() {
	...
	// clean up redis discovery client
	c.CloseRedisDiscovery()
